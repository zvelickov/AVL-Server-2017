...
{
    internal class AA08 : CEPGeneralLocationHandler, IGeneralMessageHandler
    {
        ...
        {
            if ((msg.MessageIndicator + msg.Command) == "AA08")
                return true;
            else
                return false;
        }
        ...
        public ParserResponseContainer ProcessMessage(DeviceMessage msg)
        {
            ...
            try
            {
                ...
                if (gpsData != null && sensData != null)
                {
                    ...
                    tLocation.Ns = "R";                     //Zoran.    Ova e glupo, no vo sprotivno ke treba da se dostavi edno pole vo baza (i onaka ne ni treba ovaa informacija
                    //          Ovde stavam bukva R za nova poraka. Za stara poraka ke stavam O
                    ...
                    /*
                    if (retVal.OnStationFromDateTime == DateTime.MinValue)
                        tLocation.Station = false;
                    else
                        tLocation.Station = true;
                    */
            ...
            {
                log4net.LogManager.GetLogger("MyService").Error("Greska vo obrabotka  AA08 za Vozilo", ex);
                return null;
            }
            //if (((gpsData.Longitude_X > 18 && gpsData.Longitude_X < 30) && (gpsData.Latutude_Y > 38 && gpsData.Latutude_Y < 50)))
