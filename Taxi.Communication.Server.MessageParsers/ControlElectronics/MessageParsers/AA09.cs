...
{
    internal class AA09 : CEPGeneralLocationHandler, IGeneralMessageHandler
    {
        ...
        {
            if ((msg.MessageIndicator + msg.Command) == "AA09")
                return true;
            else
                return false;
        }
        ...
        public ParserResponseContainer ProcessMessage(DeviceMessage msg)
        {
            ...
            try
            {
                ...
                if (gpsData != null && sensData != null)
                {
                    ...
                    // ZORAN:   Ovde so stanicava nema logika, bidejki ova e istoriska informcija, 
                    //          a sostojbata na vozilot e tekovna
                    //          Ne znam sto e lekot tuka. Ke stavam false, polesno na dusata ke mi bide
            ...
            {
                log4net.LogManager.GetLogger("MyService").Error("Greska vo obrabotka  AA09 za Vozilo", ex);
                return null;
            }
            //if (((gpsData.Longitude_X > 18 && gpsData.Longitude_X < 30) && (gpsData.Latutude_Y > 38 && gpsData.Latutude_Y < 50)))
