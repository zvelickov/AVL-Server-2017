...
{
    class PP74 : IGeneralMessageHandler
    {
        ...
        {
            if ((msg.MessageIndicator + msg.Command) == "PP74")
                return true;
            else
                return false;
        }
        ...
        private ReceivedFreeText parseData(byte[] msg)
        {
            ...
            byte[] tmpByteKonKogo = new byte[2];
            tmpByteKonKogo[0] = msg[0];
            Int16 m_KonKogo = System.BitConverter.ToInt16(tmpByteKonKogo, 0);
            ...
            byte[] m_string = new byte[msg.Length - 2];
