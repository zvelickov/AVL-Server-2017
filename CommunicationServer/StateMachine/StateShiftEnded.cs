...
{
    public class StateShiftEnded : VehicleState
    {
        ...
        public StateShiftEnded(Vehicle vehicle)
            : base(vehicle)
        {
            ...
            if (lstMobileOrders != null && lstMobileOrders.Count > 0)
            {
                ...
                lstMobileOrders[0].Comment = "StateShiftEnded (" + lstMobileOrders.Count.ToString() + ")";
        ...
        public override long reserveVehicle()
        {
            ...
            errStateMachine.LogStateMachineError(m_myVehicle.IdVehicle, "StateShiftEnded", "reserveVehicle", "");
            return -1;
        }
        ...
        {
            //throw new Exception("The method or operation is not implemented.");
            errStateMachine.LogStateMachineError(m_myVehicle.IdVehicle, "StateShiftEnded", "releaseVehicle", "");
            return -1;
        }
        ...
        {
            //throw new Exception("The method or operation is not implemented.");
            errStateMachine.LogStateMachineError(m_myVehicle.IdVehicle, "StateShiftEnded", "VoiceInitiate", "");
            return -1;
        }
        ...
        {
            //throw new Exception("The method or operation is not implemented.");
            errStateMachine.LogStateMachineError(m_myVehicle.IdVehicle, "StateShiftEnded", "VoiceConfirm", "");
            return -1;
        }
        ...
        {
            //throw new Exception("The method or operation is not implemented.");
            errStateMachine.LogStateMachineError(m_myVehicle.IdVehicle, "StateShiftEnded", "VoiceReject", "");
            return -1;
        }
        ...
        {
            //throw new Exception("The method or operation is not implemented.");
            errStateMachine.LogStateMachineError(m_myVehicle.IdVehicle, "StateShiftEnded", "AlarmConfirmed", "");
            return -1;
        }
        ...
        {
            //throw new Exception("The method or operation is not implemented.");
            errStateMachine.LogStateMachineError(m_myVehicle.IdVehicle, "StateShiftEnded", "AlarmRejected", "");
            return -1;
        }
        ...
        {
            //throw new Exception("The method or operation is not implemented.");
            errStateMachine.LogStateMachineError(m_myVehicle.IdVehicle, "StateShiftEnded", "AlarmReset", "");
            return -1;
        }
        ...
        {
            //throw new Exception("The method or operation is not implemented.");
            errStateMachine.LogStateMachineError(m_myVehicle.IdVehicle, "StateShiftEnded", "KeysAssigned", "");
            return -1;
        }
        ...
        {
            //throw new Exception("The method or operation is not implemented.");
            errStateMachine.LogStateMachineError(m_myVehicle.IdVehicle, "StateShiftEnded", "SendAddress", "");
            return null;
        }
        ...
        {
            //throw new Exception("The method or operation is not implemented.");
            errStateMachine.LogStateMachineError(m_myVehicle.IdVehicle, "StateShiftEnded", "CancellRequestFromClient", "");
            return -1;
        }
        ...
        {
            //throw new Exception("The method or operation is not implemented.");
            errStateMachine.LogStateMachineError(m_myVehicle.IdVehicle, "StateShiftEnded", "ExtendWaitClientTime", "");
            return -1;
        }
